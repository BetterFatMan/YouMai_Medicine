...
-(void)setCurrentMonth:(NSDateComponents *)currentMonth
{
    if(currentMonth.month > 12 || currentMonth.month < 1)
    {
        ...
        currentMonth = [currentLKCalendar components:NSYearCalendarUnit|NSMonthCalendarUnit|NSDayCalendarUnit fromDate:date];
    }
...
-(void)reloadMonthViewDate
{
    ...
    //获得第一天 是周几
    NSInteger firstWeekDay = [currentLKCalendar components:NSWeekdayCalendarUnit fromDate:firstDay].weekday;
    ...
    NSInteger size = _dayViews.count;
