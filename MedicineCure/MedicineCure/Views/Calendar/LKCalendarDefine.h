...
#define SYCC_DayWidth 44.0f*(kKeyWindow.width - 90)/320
#define SYCC_DayHeight 38.0f*(kKeyWindow.width - 90)/320
...
#define getYearMonthDateComponents(date) [currentLKCalendar components:NSYearCalendarUnit|NSMonthCalendarUnit|NSDayCalendarUnit fromDate:date]
