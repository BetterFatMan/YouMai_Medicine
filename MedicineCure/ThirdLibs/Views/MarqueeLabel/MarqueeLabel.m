...
- (void)minimizeLabelFrameWithMaximumSize:(CGSize)maxSize adjustHeight:(BOOL)adjustHeight {
    if (self.subLabel.text != nil) {
        ...
        CGSize minimumLabelSize = getStringSizeByBreakMode(self.subLabel.text, self.subLabel.font, maxSize, NSLineBreakByClipping);
...
- (void)updateSublabelAndLocationsAndBeginScroll:(BOOL)beginScroll {
    ...
    CGSize expectedLabelSize = getStringSizeByBreakMode(self.subLabel.text, self.font, maximumLabelSize, NSLineBreakByClipping);
