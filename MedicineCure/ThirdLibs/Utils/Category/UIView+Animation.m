...
+ (void)beginAnimation:(CGFloat)duration view:(UIView *)view and:(NSInteger)function
{
    CATransition *animation = [CATransition animation];
    ...
    [view.layer addAnimation:animation forKey:@"reloadAnimation"];
}

+ (void)animationAlap:(UIView *)view
{
//    CATransition *animation = [CATransition animation];
//    [animation setDuration:kTransitionTime];
//    [animation setType:kCATransitionMoveIn];
