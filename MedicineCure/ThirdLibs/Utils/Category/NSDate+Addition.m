...
- (NSString *)timeStr:(NSString *)formatStr
{
    static NSDateFormatter *dataFormatter = nil;
    dataFormatter = dataFormatter ? : [NSDateFormatter new];
    dataFormatter.dateFormat = formatStr;
    return [dataFormatter stringFromDate:self];
}

- (int)year
{
    return [[self timeStr:@"yyyy"] intValue];
}

- (int)month
{
    return [[self timeStr:@"MM"] intValue];
}

- (int)day
{
    return [[self timeStr:@"dd"] intValue];
}

- (int)hour
{
    return [[self timeStr:@"HH"] intValue];
}
...
- (int)second
{
    return [[self timeStr:@"SS"] intValue];
}
